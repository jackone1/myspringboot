...
AutoPage={
	...
	index : 1,// 第几组数据
	totalNum : 1,// 总共有几组数据
	init : function(header,content,footer,pageBreak,pageNumClass,pageSize,index,totalNum){
		...
		AutoPage.index=index;
		AutoPage.totalNum=totalNum;
		//初始化分页信息
	...
	createPage:function(startLine,offsetLine){
		...
		if(offsetLine == AutoPage.totalRecord){
			if (AutoPage.index==AutoPage.totalNum) {
